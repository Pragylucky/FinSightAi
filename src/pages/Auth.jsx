...
export function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate API call delay (remove this when backend is ready)
    await new Promise(r => setTimeout(r, 1000));

    // For now: just go to dashboard (no real auth)
    ...
    <AuthLayout title="Welcome back" subtitle="Sign in to your FinSight account">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          onClick={() => navigate('/dashboard')} // TODO: real Google OAuth
        >
