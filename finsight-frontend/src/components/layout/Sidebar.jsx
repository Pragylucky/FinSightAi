...
export default function Sidebar({ isOpen, setIsOpen }) {
      ...
      >
        ...
        <div className="p-3 border-t border-bg-border space-y-1">
          <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-text-secondary hover:text-text-primary hover:bg-bg-tertiary transition-all"
          >
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
    <div className="w-full max-w-md rounded-2xl border border-bg-border bg-bg-secondary p-6">
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
    ...
    <div className="w-full max-w-md rounded-2xl border border-bg-border bg-bg-secondary p-6">
      ...
      <div className="space-y-4">
        ...
        <button
          onClick={handleLogout}
          className="w-full rounded-lg bg-red-500/10 py-3 font-semibold text-red-400 hover:bg-red-500/20 transition"
        >
          🚪 Logout
        </button>
